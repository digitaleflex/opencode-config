...
2. Choisis l'ordre selon la tâche :
   - Code → `worker-groq` (Qwen 3.8 27B, FREE) → `worker-novita` (Ling 3.0 Flash Santé, gratuit) → `worker-pollinations` (sans clé) → **`opencode/mimo-v2.5-free`** (gratuit intégré, repli — opencode-go indisponible depuis 2026-09-19)
   - Discussion/résumé/redaction → `worker-groq` (Qwen 3.8 27B, FREE) → `worker-novita` (Ling 3.0 Flash Santé, gratuit) → `worker-pollinations` (sans clé) → **`opencode/mimo-v2.5-free`** (gratuit intégré, repli — opencode-go indisponible depuis 2026-09-19)
